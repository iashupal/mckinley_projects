...
class ArticleForm extends Component {
    ...
    cbRemoveTravelTimeTableRow = (index) => {
        let updatedData = this.state.inputList.filter((data) => {
            return data.props.childData != index;
        });
        this.setState({
            inputList: updatedData
        });
    }
    ...
    add = () => {
        this.setState({
            ...
            <TravelTimeTable cbRemove={this.cbRemoveTravelTimeTableRow} key={this.state.childCounter} childData={this.state.childCounter} />)
        });
