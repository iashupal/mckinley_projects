...
import LawFirmUI from './SignDialogs/LawFirmUI';

const { parseQueryStr, mlMessage } = RU;

// ///////////////////////////////////////////////////////////
// ///////////////////////////////////////////////////////////
// 메뉴 > 부가기능 > 회원가입 UI 보여주기용!! 실제 로그인은 하위 SiginIn.js 에서 진행
// ///////////////////////////////////////////////////////////
// ///////////////////////////////////////////////////////////
// ///////////////////////////////////////////////////////////
class LawFirmSignIn extends React.Component {
  state = {
  ...
  render() {
    ...
    return (
      ...
      <div className="">
                    ...
                    <div className={classes.loginForm}>
                      ...
                      <form>
                        <fieldset>
                          ...
                          <AlignBox>
                            <CheckBox label="Remember Email" isCrossed onChange={value => console.log(value)} />
                          </AlignBox>
                  ...
                  <div style={{ display: 'table-cell', verticalAlign: 'middle', textAlign: 'center' }}>
                    ...
                    <Box>
                      <span
                        ...
                        onClick={this.signUphandleClose}
                      >
                        로그인 하기
                      </span>
                    </Box>
        ...
        <LawFirmUI open={this.state.dialogLawFirm} />
      </div>
    );
  }
}
...
)(withStyles(styles)(LawFirmSignIn));
