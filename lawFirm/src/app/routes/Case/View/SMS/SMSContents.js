            ...
            <div style={{ padding: '10px', paddingTop: '30px', wordBreak: 'break-all' }}>
              {formMode === 'mod' && (
                <InputBox
                  rows="5"
                  multiline
                  value="안녕하세요. 법무법인 관리 시스템입니다. 다름이 아니오라 누차의 요청에도 귀하로부터 약정된 성공보수가 입금되지 않아 사무실 운영에 지장이 있습니다. 내일까지 입금 부탁 드립니다. 수고 하십시요."
                />
              )}
              {formMode !== 'mod' && (
                <div
                  dangerouslySetInnerHTML={{
                    __html: convertEditorText(
                      '안녕하세요. 법무법인 관리 시스템입니다. <br /> <br />다름이 아니오라 누차의 요청에도 귀하로부터 약정된 성공보수가 입금되지 않아 사무실 운영에 지장이 있습니다. <br /> <br />내일까지 입금 부탁 드립니다. <br /> <br /> 수고 하십시요.',
                    ),
                  }}
                />
              )}
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
              {formMode === 'mod' && (
                <Button
                  ...
                  color="primary"
                  onClick={() => {
                    setReduxValues({ _path: 'SMS', formMode: '' });
                  }}
                >
                  <Box>저장</Box>
                </Button>
              ...
              {formMode !== 'mod' && (
                <>
                  ...
                  <Button
                    ...
                    color="primary"
                    onClick={() => {
                      setReduxValues({ _path: 'SMS', formMode: 'mod' });
                    }}
                  >
                    <Box>수정</Box>
                  </Button>
