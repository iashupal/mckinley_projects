...
class LitigationList extends React.Component {
  state = {};
                    ...
                    condComponents={
                      <div style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'row', alignItems: 'flex-end' }}>
                        <Select
                          ...
                          placeholder="의뢰인 선택"
                          selectedKeys={this.props.searchClient}
                          multiSelect
                          options={R.prepend(
                        ...
                        <Select
                          ...
                          placeholder="수임자 선택"
                          selectedKeys={this.props.searchRL}
                          multiSelect
                          options={R.prepend(
                        ...
                        <Select
                          ...
                          placeholder="상태 선택"
                          selectedKeys={this.props.statusCode}
                          multiSelect
                          options={R.prepend(
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withStyles(styles)(LitigationList));
