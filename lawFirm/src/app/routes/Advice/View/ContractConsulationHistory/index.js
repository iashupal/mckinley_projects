    ...
    const { tab,files, isOpenDetail } = this.state;
        ...
        const TableComponent = () =>(
          <ContentCard
            ...
            customHeader={
              <div 
                className='customHeader-cotainer'
                >

                <div
                  className='customHeader-left'
                  >
                  <div>
            ...
            contents={[
                (
                    ...
                    <div>
                      <div
                        className={classnames("paginatn-table","left")}>
                        <Table
                          condComponents={
                            <div style={{
                            display:'flex',
                        ...
                        />
                                ...
                                <div className="font-weight-bold pl-2 pr-4">
              -
                                </div>
                                <AlignBox>
                                  <DatePicker 
            ...
            contents={
                ...
                tab === 1 && (
                  [
                    ...
                    {
                      title: '내용',
                      child: <InputBox placeholder="내용" rows="5" multiline value='2019년 법률 자문 계약에 대한 내용입니다.' />
                    },
                    {
                      title: '계약체결 일시',
                      child: (
