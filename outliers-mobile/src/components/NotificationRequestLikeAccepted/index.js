...
function NotificationRequestLikeAccepted(props) {
          ...
          <View style={styles.firstRowContainer}>
            <View style={styles.notificationTextContainer}>
              <Text style={styles.notificationText}>
                ...
                {notification.sentType === "like-accepted"
                  ? props.t("noticeScreenLang:acceptLike")
                  : notification.sentType === "like-rejected"
                  ? props.t("noticeScreenLang:rejectLike")
                  : notification.sentType === "request-accepted"
                  ? props.t("noticeScreenLang:acceptRequest")
                  : notification.sentType === "request-rejected"
                  ? props.t("noticeScreenLang:rejectRequest")
                  : ""}
              </Text>
            </View>
